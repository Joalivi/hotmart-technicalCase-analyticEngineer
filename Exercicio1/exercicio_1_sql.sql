...
-- 4. Filtrar apenas compras não canceladas (purchase_status NOT IN ('CANCELADA', 'REEMBOLSADA'))
...
WITH faturamento_produtores_2021 AS (
    ...
    WHERE 
        ...
        -- Apenas compras não canceladas
        AND p.purchase_status NOT IN ('CANCELADA', 'REEMBOLSADA')
...
-- LÓGICA:
-- 1. JOIN entre purchase e product_item para obter dados completos
-- 2. Aplicar mesmos filtros da pergunta 1 (pagas, não canceladas)
